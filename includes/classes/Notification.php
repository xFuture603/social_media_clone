...
class Notification {
  ...
  public function getNotifications($data, $limit) {
    ...
    while($row = mysqli_fetch_array($query)) {
      ...
      if($count > $limit) //this if else statement is exactly the same as the if statement above
        break;
      else
        $count++;
      ...
      $query = mysqli_query($this->conn, "SELECT * FROM users WHERE username='$user_from'");
  ...
  public function insertNotification($post_id, $user_to, $type) {
    ...
    $insert_query = mysqli_query($this->conn, "INSERT INTO notifications 
